...
managementFiles.push('src/lib/imo3d/floor-assignment.ts','src/lib/imo3d/view-presentation.ts','src/components/imo3d/viewer-plan-cache.ts');
testFiles.push('tests/imo3d-view-presentation.test.ts');
