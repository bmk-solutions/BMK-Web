 ...
 do{
  ...
  try{
   ...
   for(const floor of analysis.floors){
    ...
    const renderKey=`render-v4-${floor.floor}-`+createHash('sha256').update(JSON.stringify(floor)).digest('hex').slice(0,16);
