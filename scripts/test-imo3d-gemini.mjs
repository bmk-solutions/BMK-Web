...
const files = ['src/lib/imo3d/gemini-transport.ts', 'tests/imo3d-gemini-transport.test.ts'];
...
const result = spawnSync(process.execPath, ['--test', path.join(outputRoot, 'tests/imo3d-gemini-transport.test.js')], {stdio: 'inherit'});
