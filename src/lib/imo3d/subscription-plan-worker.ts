   ...
   for(const floor of analysis.floors){
    ...
    if(!saved){
     const audited=await reviewAndRepairPlanImage({
      ...
      read:candidate=>generatedPlanImage(candidate.imagePath,generationStarted),
